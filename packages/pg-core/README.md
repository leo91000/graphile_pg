...
This package provides the foundational interfaces and types that all PostgreSQL adapters implement, enabling a consistent stream-first API across different PostgreSQL client libraries.
